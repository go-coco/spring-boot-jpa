package com.see0gan.demo.registration;

import com.see0gan.demo.auth.ApplicationUser;
import com.see0gan.demo.auth.ApplicationUserService;
import com.see0gan.demo.email.EmailSender;
import com.see0gan.demo.email.EmailValidator;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
       ...
       String token = applicationUserService.signUpUser(
                new ApplicationUser(
                        ...
                        request.getPassword(),
                        request.getName(),
                        ApplicationUserRole.HOST // TODO : different sign up endpoint to decide GUEST or HOST
                )
        );
    ...
    public String confirmToken(String token){
        ...
        applicationUserService.enableAppUser(confirmationToken.getAppUser().getEmail());
